...
from sandbox_app.backend.api.generate_dataset import router as generate_dataset_router
from sandbox_app.backend.api.generate_history import router as generate_history_router
...
app.include_router(generate_history_router)
app.include_router(generate_dataset_router)
