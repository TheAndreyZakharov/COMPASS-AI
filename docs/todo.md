...
- [X] Описать, что такое COMPASS AI.
- [X] Описать проблему.
- [X] Описать решение.
- [X] Описать архитектуру.
- [X] Описать agentic pipeline.
- [X] Описать ML-модель.
- [X] Описать интеграцию с Plane.
- [X] Описать Plane Live recommendations.
- [X] Описать ручную историю сотрудников.
- [X] Описать ONNX export.
- [X] Описать Jupyter reports.
- [X] Описать dashboard.
- [X] Описать sandbox-подпроект.
- [X] Описать локальный запуск.
- [X] Описать демо-сценарии.
- [X] Добавить скриншоты.
- [X] Добавить ограничения проекта.
- [X] Указать, что часть данных синтетическая.
- [X] Указать, что проект учебный.
...
- [X] Проверить, что `docs/doc.md` соответствует реальной реализации.
- [X] Удалить обещания, которые не были сделаны.
- [X] Добавить реальные названия файлов.
- [X] Добавить реальные endpoints.
- [X] Добавить реальные модели.
- [X] Добавить реальные метрики.
- [X] Добавить реальные ограничения.
- [X] Добавить схему архитектуры.
- [X] Добавить описание sandbox-подпроекта.
...
- [X] Описать `/health`.
- [X] Описать `/version`.
- [X] Описать `/recommendations/demo`.
- [X] Описать `/recommendations/manual`.
- [X] Описать `/recommendations/issue/{issue_id}`.
- [X] Описать `/recommendations/project/{project_id}/open-issues`.
- [X] Описать Plane Live endpoints.
- [X] Описать members endpoints.
- [X] Для каждого endpoint указать request.
- [X] Для каждого endpoint указать response.
- [X] Для каждого endpoint указать пример.
...
- [X] Создать `docs/ml_model.md`.
- [X] Описать задачу ML.
- [X] Описать synthetic data.
- [X] Описать ручную историю.
- [X] Описать признаки.
- [X] Описать label.
- [X] Описать архитектуру `TaskEmployeeMatchingNet`.
- [X] Описать обучение.
- [X] Описать метрики.
- [X] Описать baseline comparisons.
- [X] Описать ONNX export.
...
- [X] Создать `docs/plane_integration.md`.
- [X] Описать, как Plane используется.
- [X] Описать, какие сущности Plane используются.
- [X] Описать REST API integration.
- [X] Описать MCP experiment.
- [X] Описать Plane Live candidate scope.
- [X] Описать real project members.
- [X] Описать write-back comments.
- [X] Описать auto-assign mode.
- [X] Описать ручную историю сотрудников.
- [X] Описать ограничения self-hosted Plane.
- [X] Описать настройку `.env`.
...
- [X] Создать `docs/sandbox_app.md`.
- [X] Описать назначение подпроекта.
- [X] Описать автономность песочницы.
- [X] Описать структуру `sandbox_app`.
- [X] Описать импорт датасета.
- [X] Описать генерацию датасета по seed.
- [X] Описать custom features.
- [X] Описать обучение модели через UI.
- [X] Описать экспорт ONNX.
- [X] Описать генерацию тестовой команды.
- [X] Описать assignment simulation.
...
- [X] Сделать скриншот Plane workspace.
- [X] Сделать скриншот задачи до рекомендации.
- [X] Сделать скриншот комментария COMPASS AI в Plane.
- [X] Сделать скриншот dashboard overview.
- [X] Сделать скриншот Plane Live page.
- [X] Сделать скриншот recommendation result.
- [X] Сделать скриншот team workload.
- [X] Сделать скриншот model metrics.
- [X] Сделать скриншот fairness analysis.
- [X] Сделать скриншоты sandbox app.
- [X] Сохранить скриншоты в `docs/assets`.
...
- [X] Проверить, что `.env` не попал в git.
- [X] Проверить, что Plane API key не попал в git.
- [X] Проверить, что тяжёлые модели не попали в git, если они слишком большие.
- [X] Проверить, что synthetic generated files либо игнорируются, либо осознанно оставлены.
- [X] Проверить, что sandbox generated files не засоряют git.
- [X] Проверить, что README не содержит секретов.
- [X] Проверить, что docs не содержат секретов.
- [X] Запустить `pytest`.
- [X] Запустить `ruff`.
- [X] Запустить API.
- [X] Запустить dashboard.
- [X] Запустить sandbox app.
...
- [X] Plane локально запускается.
- [X] В Plane есть workspace, проекты, задачи и demo-команда.
- [X] В Plane есть ручная история выполненных и невыполненных задач.
- [X] COMPASS API запускается локально.
- [X] Dashboard запускается локально.
- [X] Dashboard визуально доведён до нормального состояния.
- [X] Plane Live recommendations используют только real project members.
- [X] Синтетические данные генерируются одной командой.
- [X] Features строятся одной командой.
- [X] Собственная нейронная сеть обучается.
- [X] Есть сохранённый `.pt` checkpoint.
- [X] Есть экспортированный `.onnx` файл.
- [X] ONNX inference проверен.
- [X] Есть top-3 рекомендации по задаче.
- [X] Есть 4 режима рекомендации.
- [X] Есть русскоязычное объяснение через LLM.
- [X] Есть fallback explanation без LLM.
- [X] Есть запись рекомендации в Plane comment.
- [X] Есть safe optional auto-assign.
- [X] Есть batch-анализ задач проекта.
- [X] Есть Jupyter notebooks.
- [X] Есть HTML-отчёты.
- [X] Есть fairness-анализ.
- [X] Есть comparison с random baseline.
- [X] Есть comparison с rule-based baseline.
- [X] Есть тесты.
- [X] Есть автономный sandbox-подпроект.
- [X] Sandbox умеет импортировать датасет.
- [X] Sandbox умеет генерировать датасет по seed.
- [X] Sandbox умеет обучать модель через UI.
- [X] Sandbox умеет экспортировать ONNX.
- [X] Sandbox умеет генерировать тестовую команду и текущие задачи.
- [X] Sandbox умеет проверять распределение задач выбранной ONNX-моделью.
- [X] Sandbox умеет объяснять результат через Qwen.
- [X] README обновлён.
- [X] Документация обновлена.
- [X] Скриншоты добавлены.
- [X] Секреты не попали в git.
