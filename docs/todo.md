...
- [ ] Проверить, что путь проекта правильный.
- [ ] Проверить, что в проекте сейчас есть `README.md`, `LICENSE`, `docs/doc.md`, `docs/todo.md`.
- [ ] Убедиться, что репозиторий называется `COMPASS-AI`.
...
- [ ] Создать папку `app` для FastAPI-приложения.
- [ ] Создать папку `config` для конфигураций.
- [ ] Создать папку `data` для данных.
- [ ] Создать папку `data/raw` для исходных выгрузок.
- [ ] Создать папку `data/synthetic` для синтетических данных.
- [ ] Создать папку `data/processed` для подготовленных датасетов.
- [ ] Создать папку `models` для обученных моделей.
- [ ] Создать папку `notebooks` для Jupyter-ноутбуков.
- [ ] Создать папку `reports` для HTML/PDF-отчётов.
- [ ] Создать папку `scripts` для CLI-скриптов.
- [ ] Создать папку `src` для основного Python-кода.
- [ ] Создать папку `src/agents` для агентов.
- [ ] Создать папку `src/data` для генерации и обработки данных.
- [ ] Создать папку `src/features` для feature engineering.
- [ ] Создать папку `src/integration` для интеграции с Plane.
- [ ] Создать папку `src/llm` для LLM-объяснений.
- [ ] Создать папку `src/models` для ML-моделей.
- [ ] Создать папку `src/recommendation` для ranking/recommendation logic.
- [ ] Создать папку `src/reports` для генерации отчётов.
- [ ] Создать папку `src/utils` для общих утилит.
- [ ] Создать папку `tests` для тестов.
- [ ] Создать папку `tools` для локальных вспомогательных инструментов.
- [ ] Создать папку `plane` для локальных файлов, связанных с Plane.
- [ ] Создать папку `plane/docker` для конфигураций запуска Plane.
- [ ] Создать папку `plane/seed` для подготовки данных Plane.
...
- [ ] Создать `Makefile`.
- [ ] Создать `docker-compose.compass.yml`.
- [ ] Создать `config/settings.yaml`.
- [ ] Создать `config/paths.yaml`.
...
- [ ] Убедиться, что используется Python 3.11 или 3.12.
- [ ] Если Python не установлен, установить через Homebrew.
...
- [ ] Создать `.venv` в корне проекта.
- [ ] Активировать окружение.
- [ ] Обновить `pip`.
- [ ] Проверить, что Python берётся из `.venv`.
...
- [ ] Добавить библиотеки для данных.
- [ ] Добавить библиотеки для ML.
- [ ] Добавить библиотеки для ONNX.
- [ ] Добавить библиотеки для API.
- [ ] Добавить библиотеки для Jupyter.
- [ ] Добавить библиотеки для отчётов.
- [ ] Добавить библиотеки для интеграции.
- [ ] Добавить библиотеки для LLM/embeddings.
...
- [ ] Добавить инструменты форматирования.
- [ ] Добавить инструменты тестирования.
- [ ] Добавить инструменты проверки типов.
...
- [ ] Указать настройки `black`.
- [ ] Указать настройки `ruff`.
- [ ] Указать настройки `pytest`.
- [ ] Указать настройки `mypy`.
- [ ] Указать версию Python.
- [ ] Указать, что основной пакет находится в `src`.
